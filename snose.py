...
class SnosSystem2Mod(loader.Module):
    """Модуль для массового сноса через жалобы v2"""
    strings = {"name": "SnosSystem2"}

    async def snos1cmd(self, message):
        ...
        result_text = (
            ...
            f"📊 Жалоб: {complaints}\n"
            f"🎯 Цель: {target}\n"
            f"💀 Статус: Отменить снос можно в течении 10 минут, или аккаунт будет удален"
        )
